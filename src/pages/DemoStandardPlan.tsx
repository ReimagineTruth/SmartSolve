    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-text mb-2">Welcome to SmartSolve Standard!</h1>
          <p className="text-gray-600 text-sm sm:text-base">Unlimited tasks, advanced budget tools, and AI-powered features.</p>
        </div>

        {/* Stats Overview */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-6 mb-6 sm:mb-8">
          <div className="card text-center p-3 sm:p-4">
            <div className="text-lg sm:text-2xl font-bold text-primary mb-1 sm:mb-2">{tasks.length}</div>
            <div className="text-xs sm:text-sm text-gray-600">Total Tasks</div>
          </div>
          <div className="card text-center p-3 sm:p-4">
            <div className="text-lg sm:text-2xl font-bold text-primary mb-1 sm:mb-2">{meals.length}</div>
            <div className="text-xs sm:text-sm text-gray-600">Meal Plans</div>
          </div>
          <div className="card text-center p-3 sm:p-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="card">
            <div className="flex items-center justify-between mb-4 sm:mb-6">
              <h2 className="text-lg sm:text-xl font-semibold text-text">Unlimited Tasks</h2>
          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl p-4 sm:p-6 text-white">
            <div className="flex flex-col sm:flex-row items-center justify-between">
              <div className="text-center sm:text-left mb-4 sm:mb-0">
                <h3 className="text-lg sm:text-xl font-bold mb-2">Pi Network Integration</h3>
                <p className="text-xs sm:text-sm opacity-90 mb-3 sm:mb-0">
                  Pay securely with Pi cryptocurrency - fast, global, and decentralized
                </p>
              </div>
            ...
            <div className="mt-3 sm:mt-4 text-center">
              <button className="bg-white text-blue-600 px-4 sm:px-6 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-xs sm:text-sm">
                Connect Pi Wallet
              </button>
            </div>
          </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl p-4 sm:p-8 max-w-md w-full max-h-[90vh] overflow-y-auto">
              <div className="text-center mb-4 sm:mb-6">
                <h3 className="text-lg sm:text-2xl font-bold text-text mb-2">Upgrade to Premium</h3>
                <p className="text-gray-600 text-sm sm:text-base">Unlock family features, kids mode, and group collaboration!</p>
              </div>
              
              <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                <div className="flex items-center">
                  <Check className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 mr-2 sm:mr-3" />
                  <span className="text-sm sm:text-base">Family Calendar & Task Sharing</span>
                </div>
                <div className="flex items-center">
                  <Check className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 mr-2 sm:mr-3" />
                  <span className="text-sm sm:text-base">Kids Mode with Rewards</span>
                </div>
                <div className="flex items-center">
                  <Check className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 mr-2 sm:mr-3" />
                  <span className="text-sm sm:text-base">Group Chat & File Sharing</span>
                </div>
                <div className="flex items-center">
                  <Check className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 mr-2 sm:mr-3" />
                  <span className="text-sm sm:text-base">Full Grocery Planner</span>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                ...
                <Link
                  to="/pricing"
                  className="flex-1 px-4 py-2 bg-primary text-white rounded-lg hover:bg-secondary text-center text-sm sm:text-base"
                >
                  View Plans
                </Link>
              </div>
